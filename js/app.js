...
if (narrator == 'Yes' || narrator == 'yes') {
    ...
    if(story_Begins == 'roll' || story_Begins == 'Roll' || story_Begins == 'ROLL') {
        ...
        if(random_coins != 0 || random_cattle != 0 || random_food != 0) {
            ...
            if (stageOne == 'yes' || stageOne == 'Yes' ) {
                ...
                if (coins < 40) { 
                    ...
                    if(food_given > 0) {
                        ...
                        stageOne_End = alert('The merchant thank you for your purchase and speeds off. You wonder if they were lying and check the bag. Sadly, to your disappointment, you\'ve been robbed. [Food given: ' + food_given + '. Coins: -40] [END OF DAY ONE]');
                        food += food_given;
                        coins -= 40;
                ...
                if (cattle > 10){
                    ...
                    merchant = alert('The merchant went away hanging his head, and you couldn\'t help but feel a sting of pity. However, you continue with your day. As night comes along, you get ready for bed and patiently wait to start your next day. Later that night, the merchant comes by with a lighter and gasoline. As he checks your wares however, he sees why you couldn\'t pay anyway and leaves shaking their head. [END OF DAY ONE]'); 
                }
            ...
            stageTwo = prompt('Day 2: The second day is always filled with promise, (unless you had a really bad roll or got robbed or...nevermind). As you get ready to head off into town, a farmer comes by very distraught. They say a merchant-looking person came by and burned all their cattle. The suspect sounded familar, (but you didn\'t have problems with them right?) They ask if you have any cattle to spare. At least 10 will do. Will you help? (Yes / No).');

            if (stageTwo == 'yes' || stageTwo == 'Yes') {

                if (cattle < 10) {

                    stageOne_End = alert('You explain to the farmer that you have less than that, and they smile sadly and nod. "That\'s fine, thanks for trying.", and they leave. This is a very sad moment for you, so you took the time to take care of what measly cattle you have. [END OF DAY TWO]' ) 
                ...
                stageThree = prompt('Day 3: The third day is...you know the line. You head off towards the trade market in town, hoping to sell some stuff while you\'re there. You come across two traders selling unusual items. One offers a yellow potion and tells you that it grants wealth. The other tells you of a purple potion that tastes like grape. You don\'t want either, but they both convince you that the samples are free. You, not willing to turn down free samples, decided to pick one. Which do you choose? (Yellow / Purple).');

                if (stageThree == 'yellow' || stageThree == 'Yellow' ) {

                    end_fail = alert('So, you won\'t believe this, but the guy with the yellow potion was lying! Crazy right? After drinking it, some crazy events begin to happen. Long story short, you died from poisoning by arsenic and...well...let\'s just say that yellow tint wasn\'t food coloring ok? ["Watch those free samples" END]') 
                    ...
                    stageFour= prompt('Day 4: {Insert line here}. You wake up and get ready for the day. As you\'re cooking, you hear a knock at the door. You remembered that you wern\'t expecting visitors for another three months. A wave of suspicion hits you like a semi. Should you open the door? (Yes/ No).');
                    ...
                    if (stageFour == 'yes' || stageFour == 'Yes' ) {
                        ...
                        end_fail = alert('The knocking persists and you start to grow more and more fightened. Then, the door breaks off the hinges, and an old lady steps in with a mask on. The look on her face was pure anger, and she lunges at you with a baguette, slapping you continously with it. As you slowly lose consciousness, you think to yourself: /Grandma?/ before blacking out. ["Beaten by Granny\'s Baguette" END]')    
                    }
